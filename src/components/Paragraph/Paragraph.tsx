    ...
    <>
      ...
      <div className="lg:flex lg:justify-center">
        <div className="bg-white lg:flex lg:max-w-5xl lg:shadow-lg lg:rounded">
          <div className="h-64 bg-cover lg:w-1/2 lg:rounded lg:h-full">
            <GatsbyImage
              image={image.childImageSharp.gatsbyImageData}
              className="h-64 rounded-t-lg lg:h-full lg:rounded"
              alt="Person raising both arms to show triumph, Photo by bruce mars on Unsplash"
              imgStyle={{ objectFit: 'cover', objectPosition: '0% 25%' }}
            />
          </div>
          <div className="px-6 py-6 lg:py-12 lg:max-w-5xl lg:w-1/2">
            ...
            <a
              href="#"
              className="px-5 py-3 font-semibold text-gray-100 bg-teal-900 rounded"
            >
              Read more
            </a>
          </div> */}
