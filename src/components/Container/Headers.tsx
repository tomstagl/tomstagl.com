...
export const H1: FunctionComponent = ({ children }) => (
  <h1 className="pb-4 text-3xl uppercase lg:text-center">{children}</h1>
);
// TODO: make header for blog list. Original was:h2 {@apply text-2xl;}

export const H2: FunctionComponent = ({ children }) => (
  <h2 className="pb-4 text-3xl uppercase lg:text-center">{children}</h2>
);

export const H3: FunctionComponent = ({ children }) => (
  <h3 className="text-2xl uppercase lg:text-center">{children}</h3>
);
