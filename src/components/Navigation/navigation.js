  ...
  return (
    <>
      ...
      <div
        ...
        id="nav-menu"
      >
        <ul className="my-2 p-4 bg-gray-200 shadow flex flex-grow flex-col items-center justify-center lg:flex-row lg:p-0 lg:bg-white lg:w-auto lg:shadow-none lg:justify-end">
          {navItems}
        </ul>
      </div>
    </>
